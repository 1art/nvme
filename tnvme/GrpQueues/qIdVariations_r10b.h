...
#ifndef _QIDVARIATIONS_r10b_H_
#define _QIDVARIATIONS_r10b_H_
...
public:
     ...
     */
    virtual QIDVariations_r10b *Clone() const
        { return new QIDVariations_r10b(*this); }
    QIDVariations_r10b &operator=(const QIDVariations_r10b &other);
    QIDVariations_r10b(const QIDVariations_r10b &other);
