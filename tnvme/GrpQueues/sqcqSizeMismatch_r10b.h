...
#ifndef _SQCQSIZEMISMATCH_r10b_H_
#define _SQCQSIZEMISMATCH_r10b_H_
...
public:
     ...
     */
    virtual SQCQSizeMismatch_r10b *Clone() const
        { return new SQCQSizeMismatch_r10b(*this); }
    SQCQSizeMismatch_r10b &operator=(const SQCQSizeMismatch_r10b &other);
    SQCQSizeMismatch_r10b(const SQCQSizeMismatch_r10b &other);
