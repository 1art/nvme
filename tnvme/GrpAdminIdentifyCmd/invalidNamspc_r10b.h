...
#ifndef _INVALIDNAMSPC_r10b_H_
#define _INVALIDNAMSPC_r10b_H_
...
public:
     ...
     */
    virtual InvalidNamspc_r10b *Clone() const
        { return new InvalidNamspc_r10b(*this); }
    InvalidNamspc_r10b &operator=(const InvalidNamspc_r10b &other);
    InvalidNamspc_r10b(const InvalidNamspc_r10b &other);
